...
public partial class WorldClient
{
    ...
    void HandleEnumCharactersResult(WorldPacket packet)
    {
        ...
        // V3_4_3 expects HasDisabledClassesMask=true followed by an explicit
        // zero mask. Omitting the four-byte field makes the envelope too short.
        charEnum.DisabledClassesMask = ModernVersion.Build == ClientVersionBuild.V3_4_3_54261
            ? 0u
            : null;
        ...
        for (byte i = 0; i < count; i++)
        {
            ...
            char1.SpecID = 0;
            char1.Unknown703 = 0;
            // This field is the character's legacy last-played build, not the
            // modern client build. 54261 here causes the 3.4.3 list entry to be
            // rejected even though the enum packet itself was sent successfully.
            char1.LastLoginVersion = ModernVersion.Build == ClientVersionBuild.V3_4_3_54261
                ? (uint)LegacyVersion.BuildInt
                : (uint)ModernVersion.BuildInt;
